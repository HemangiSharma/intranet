...
define('TOWNSHIPLITE_FREE_THEME_DOC','https://themescaliber.com/doc/free-tc-township/','township-lite');
define('TOWNSHIPLITE_SUPPORT','https://wordpress.org/support/theme/township-lite/','township-lite');
define('TOWNSHIPLITE_REVIEW','https://www.themescaliber.com/topic/reviews-and-testimonials','township-lite');
define('TOWNSHIPLITE_BUY_NOW','https://www.themescaliber.com/premium/wp-township-construction-wordpress-theme','township-lite');
define('TOWNSHIPLITE_LIVE_DEMO','https://themescaliber.com/township-theme/','township-lite');
define('TOWNSHIPLITE_PRO_DOC','https://themescaliber.com/doc/tc-township-pro/','township-lite');
define('TOWNSHIPLITE_CHILD_THEME','https://developer.wordpress.org/themes/advanced-topics/child-themes/','township-lite');
